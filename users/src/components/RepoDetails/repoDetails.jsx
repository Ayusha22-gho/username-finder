...
export default function index({ repoData, followRepo }) {
  ...
  const follows = followRepo.filter((user) => user.id === followId);
  return (
    <>
    <p>Go to Home Page</p>
    <Link to = "/">Home</Link>
    <div className="detail-container">
      {details.length > 0 && (
        <>
          <div className="detail-user-info">
            <img
              src={details[0].owner.avatar_url}
              alt=""
              width={100}
              height={100}
            />
      ...
      {follows.length > 0 && (
        <>
          <div className="detail-user-info">
            <img
              src={follows[0].owner.avatar_url}
              alt=""
              width={100}
              height={100}
            />
